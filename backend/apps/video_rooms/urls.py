...
urlpatterns = [
    ...
    path('rooms/<int:room_id>/participants/', views.get_room_participants, name='get-room-participants'),
    ...
    path('debug/agora/', views.debug_agora_config, name='debug-agora-config'),
]